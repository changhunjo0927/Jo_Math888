...
For future research direction, we can consider extension to treatment with multiple levels since we assumed binary treatment in the paper. Second, we focused on estimating the marginal excursion effect, however, introducing random effects to the excursion effect and allowing person-specific predictions would be interesting.
